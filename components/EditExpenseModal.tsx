  ...
  [
    {
      ...
      label: "High",
      Icon: ArrowUp,
      color: "text-red-600 bg-red-50 border-red-200 data-[active=true]:ring-red-400",
    },
    {
      value: "Medium",
      label: "Medium",
      Icon: Minus,
      color: "text-amber-600 bg-amber-50 border-amber-200 data-[active=true]:ring-amber-400",
    },
    {
      value: "Low",
      label: "Low",
      Icon: ArrowDown,
      color: "text-zinc-500 bg-zinc-100 border-zinc-200 data-[active=true]:ring-zinc-400",
    },
  ];
...
export function EditExpenseModal({ expense, open, onClose, onSave }: EditExpenseModalProps) {
  ...
  return (
    ...
    >
      <DialogContent className="sm:max-w-lg rounded-2xl border border-zinc-200 bg-white p-0 shadow-xl">
        ...
        <div className="px-6 py-5 space-y-4">
          ...
          <div className="space-y-1.5">
            ...
            <p className="text-[10px] text-zinc-400">
              Setting to <span className="font-semibold text-emerald-600">paid</span> will mark the
              full amount as paid. Use <span className="font-semibold">Amount paid</span> above to
            ...
            <div className="flex gap-2">
              {(["unpaid", "paid"] as Status[]).map((s) => (
                <button
                  ...
                  onClick={() => {
                    setStatus(s);
                    // Auto-fill amountPaid when marking as paid
                    if (s === "paid") {
